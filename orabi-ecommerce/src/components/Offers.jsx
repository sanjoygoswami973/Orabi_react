...
import Offers_img1 from "../assets/offers_img1.jpg";
import Offers_img2 from "../assets/offers_img2.jpg";
import Offers_img3 from "../assets/offers_img3.jpg";
import Offers_img4 from "../assets/offers_img4.jpg";
    ...
    <>
      <Container className=" mt-12 sm:max-xl:mt-20 2xl:mt-28">
        ...
        <div className="relative">
          ...
          >
            <div>
              <Product src={Offers_img1} alt="offers_img1" badge={true} />
            </div>
            <div>
              <Product src={Offers_img2} alt="offers_img2" badge={true} />
            </div>
            <div>
              <Product src={Offers_img3} alt="offers_img3" badge={true} />
            </div>
            <div>
              <Product src={Offers_img4} alt="offers_img4" badge={true} />
            </div>
          </Slider>
